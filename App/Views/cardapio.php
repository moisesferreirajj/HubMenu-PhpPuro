...
=======
    ...
    <!-- Bootstrap Icons -->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-icons/1.11.2/font/bootstrap-icons.min.css" rel="stylesheet">
    <link type="text/css" rel="stylesheet" href="/Views/Assets/Css/cardapio.css">
...
<body>
    ...
    <div class="container py-4">
        ...
        <div class="card h-100 category-food">
            <span class="category-badge badge-food">Comida</span>
            <button class="btn btn-circle edit-button">
        ...
        <div class="card h-100 category-dessert">
            ...
            <img src="https://www.shutterstock.com/image-photo/healthy-summer-acai-smoothie-bowl-260nw-2262525705.jpg" class="card-img-top" alt="Pizza">
            <div class="card-body">
                <h5 class="card-title mb-0">Açai</h5>
                <button class="btn btn-cart w-100">
                    <i class="bi bi-cart-plus"></i>
                    Adicionar ao carrinho
                </button>
        ...
        <div class="card h-100 category-drink">
            ...
            <img src="https://www.shutterstock.com/image-photo/usa-california-01-october-2019-260nw-1553467073.jpg" class="card-img-top" alt="Coca">
            <div class="card-body">
                <h5 class="card-title mb-0">Coca-Cola</h5>
                <button class="btn btn-cart w-100">
                    <i class="bi bi-cart-plus"></i>

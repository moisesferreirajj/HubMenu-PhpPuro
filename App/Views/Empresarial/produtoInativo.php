<?php
$produtos = $ProdutosDesativados ?? []; // Produtos desativados, a serem passados pelo controlador
...
<head>
    ...
    <title>Lixeira - Menu de Alimentos</title>
...
<body>
    ...
    <div class="content">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
            <div class="container">
                ...
                <div class="d-flex gap-2 ms-auto">
                    <a href="/empresarial/cardapio" class="btn btn-light btn-circle" title="Voltar ao Cardápio">
        ...
        <div class="container py-4">
            <h1 class="rowCategory">Produtos Desativados</h1>
                ...
                ?>
                    <div class="col animated-card"
                        ...
                        <div class="card <?php echo $cardClass; ?>"
                            ...
                            <button class="btn btn-circle reativar-button" data-id="<?php echo $produto->id; ?>">

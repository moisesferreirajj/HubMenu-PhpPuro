    ...
    <div class="order-container">
        <div class="card">
            <div class="card-header">
                <span class="order-id">Pedido 177</span>
                <span class="order-client">Cristiano Ronaldo</span>
            </div>

            <div class="item">
                <div class="item-info">
                    <span class="quantity">1x</span>
                    <span class="item-name">Duplo Burger</span>
                </div>
                <div class="item-obs"><span class="item-extra">+ Cheddar Premium</span>
                </div>
            </div>
            <div class="item">
                <div class="item-info">

<?php
error_log('Produtos inativos na view: ' . count($produtos));
?>
...
<head>
  ...
  <title><?php echo htmlspecialchars($Title); ?> Produtos Inativos</title>
  ...
  <script src="/Views/Assets/Js/lixeira.js" defer></script>
</head>
<body>
...
<div class="content">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    <div class="container">
      ...
      <?php if ($estabelecimento && !empty($estabelecimento->nome)): ?>
        <div class="banner-estabelecimento mb-4 d-flex align-items-center justify-content-center" style="width:100%;height:100px;overflow:hidden;">
          <h2 class="mb-0"><?php echo htmlspecialchars($estabelecimento->nome); ?></h2>
        </div>
      <?php else: ?>
  ...
  <?php if (!empty($erro)): ?>
    <div class="alert alert-danger">Erro ao carregar produtos inativos: <?php echo htmlspecialchars($erro); ?></div>
  <?php endif; ?>

  <!-- Banner do Estabelecimento -->
  <?php if ($estabelecimento && !empty($estabelecimento->banner)): ?>
    <div class="banner-estabelecimento mb-4" style="width:100%;height:220px;overflow:hidden;">
      <img src="<?php echo htmlspecialchars($estabelecimento->banner); ?>" alt="Banner do Estabelecimento" style="width:100%;height:220px;object-fit:cover;">
    </div>
  <?php else: ?>
    <div class="banner-estabelecimento mb-4 text-center p-4 bg-light border" style="height:220px;display:flex;align-items:center;justify-content:center;">
      <p class="text-muted mb-0">Este estabelecimento ainda não possui um banner.</p>
  ...
  <div class="container py-4">
    ...
    <?php else: ?>
      <div class="row row-cols-2 row-cols-md-2 row-cols-lg-4 g-4" id="produtos-lista">
        ...
        ?>
          <div class="col animated-card" data-categoria="<?php echo strtolower(htmlspecialchars($produto->categoria_nome ?? '')); ?>" style="animation-delay: 0.2s">
            <div class="card <?php echo $cardClass; ?>"
              ...
              <button class="btn btn-circle btn-warning reativar-button" data-id="<?php echo $produto->id; ?>">
                <i class="bi bi-arrow-clockwise"></i>
              </button>

              <img src="<?php echo ($produto->imagem ?: '/images/default.png'); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($produto->nome); ?>">
...
<!-- Bootstrap fallback JS (caso precise em algum navegador antigo) -->

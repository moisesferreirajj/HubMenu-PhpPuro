...
INSERT INTO `estabelecimentos` (`id`, `nome`, `cep`, `endereco`, `cnpj`, `imagem`, `banner`, `cor1`, `cor2`, `cor3`, `tipo`, `media_avaliacao`) VALUES
	(1, 'Pizzaria Saborosa', '89200-000', 'Rua das Flores, 123', '12.345.678/0001-00', '/Views/Assets/Images/Estabelecimentos/LaBellaItalia.jpg', '/Views/Assets/Images/Estabelecimentos/Banners/LaBellaItalia.jpg', '#FF5733', '#33FF57', '#3357FF', 'Pizzaria', 4.50),
	(2, 'Churrascaria Boi na Brasa', '89200-001', 'Avenida Central, 456', '23.456.789/0001-11', '/Views/Assets/Images/Estabelecimentos/BoiNaBrasa.png', NULL, '#FF5733', '#33FF57', '#3357FF', 'Churrascaria', 4.70),
...
INSERT INTO `estabelecimentos_usuarios` (`id`, `usuario_id`, `cargo_id`, `estabelecimento_id`) VALUES
  (1, 1, 1, 1),    -- João Silva, Administrador
  (2, 2, 2, 2),    -- Maria Oliveira, Gerente
  (3, 3, 3, 3),    -- Pedro Santos, Atendente
  (4, 4, 4, 4),    -- Ana Souza, Cozinheiro
  (5, 5, 5, 5),    -- Lucas Lima, Entregador
  (6, 6, 6, 6),    -- Carla Pereira, Caixa
  (7, 7, 7, 7),    -- Marcos Almeida, Garçom
  (8, 8, 8, 8),    -- Fernanda Costa, Supervisor
  (9, 9, 9, 9),    -- Rafael Rodrigues, Aux. Limpeza
  (10, 11, 1, 1),  -- Moisés, Admin
  (11, 12, 1, 1);  -- Yohan, Admin
...
INSERT INTO `pedidos_produtos` (`id`, `pedido_id`, `produto_id`, `quantidade`, `preco_unitario`) VALUES
	(5, 1, 2, 2, 19.99),
	(6, 1, 1, 1, 29.90),
	(7, 2, 4, 3, 9.50),
	(8, 3, 5, 1, 49.99);
...
INSERT INTO `produtos` (`id`, `nome`, `descricao`, `valor`, `imagem`, `status_produtos`, `estabelecimento_id`, `categoria_id`) VALUES
	...
	(13, 'Rato Empanado', 'Delicioso rato empanado, receita original da casa.', 25.00, '/Views/Assets/Images/Produtos/6830c89dad57d.png', 1, 6, 4),
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `senha`, `cargo_id`, `cep`, `endereco`, `telefone`) VALUES
	...
	INSERT INTO `usuarios` (`id`, `nome`, `email`, `senha`, `cargo_id`, `cep`, `endereco`, `telefone`) VALUES
  (1, 'João Silva', 'joao@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 1, '89200-010', 'Rua A, 100', '(47) 99999-0001'),
  (2, 'Maria Oliveira', 'maria@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 2, '89200-011', 'Rua B, 200', '(47) 99999-0002'),
  (3, 'Pedro Santos', 'pedro@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 3, '89200-012', 'Rua C, 300', '(47) 99999-0003'),
  (4, 'Ana Souza', 'ana@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 4, '89200-013', 'Rua D, 400', '(47) 99999-0004'),
  (5, 'Lucas Lima', 'lucas@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 5, '89200-014', 'Rua E, 500', '(47) 99999-0005'),
  (6, 'Carla Pereira', 'carla@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 6, '89200-015', 'Rua F, 600', '(47) 99999-0006'),
  (7, 'Marcos Almeida', 'marcos@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 7, '89200-016', 'Rua G, 700', '(47) 99999-0007'),
  (8, 'Fernanda Costa', 'fernanda@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 8, '89200-017', 'Rua H, 800', '(47) 99999-0008'),
  (9, 'Rafael Rodrigues', 'rafael@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 9, '89200-018', 'Rua I, 900', '(47) 99999-0009'),
  (10, 'Juliana Martins', 'juliana@example.com', '$2y$2y$10$PlZAEZtmmsh7zQcuN4P1Z.5l2sDCWLcb7k2k7hyCxf0bT0uk3i1NO', 10, '89200-019', 'Rua J, 1000', '(47) 99999-0010'),
  (11, 'Moises Joao Ferreira', 'benimaru@gmail.com', '$2y$10$zbowC/fIsqDg4/kI.wwleeJxFZ151PY6rClAwJzLI9/Wc3uzV1kwK', 1, '89223-110', 'Rua Inexiste, 801', '(47) 99127-0120'),
  (12, 'Yohan Siedschlag', 'cautios2.0@gmail.com', '$2y$10$VdPiKi4c.GfqCM5eWR3T/uQSoMLrJ9oQB20b8WWH6yMAIgZGvh/pC', 1, '21543-677', 'Rua do God War, 111', '(14) 23156-3464');
